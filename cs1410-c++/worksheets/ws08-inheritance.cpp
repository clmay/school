...
int main(int argc, char const *argv[])
{
    ...
    public:
        ...
        Date2::Date2() : month(1), day(1), year(1900)
        {
        } // Constructor # 1

        //TODO: Second constructor's implemenation
        Date2::Date2(int mm, int dd, int yy) : month(mm), day(dd), year(yy) {} // Constructor # 2
    ...
    // As protected members, they can only be utilized within the class itself, not outside.
    // These could be inherited and used within derived classes, but if inherited cannot be
    // used outside of any of the derived/deriving classes.
    ...
    // As private members, these can neither be used outside of the class definition (as attempted above),
    // nor could they be inherited or used within any other derived classes.
