...
int main(int argc, char const* argv[])
{
    ...
    while (true) {
        ...
        if (input < 1 || input > 100) {
            ...
            // and use the comparison logic to get an update value on successive inputs.
            {
    ...
    cout << setw(6) << "Count" << setw(9) << "Minimum" << setw(9)
         << "Maximum" << setw(9) << "Average" << endl;
    cout << setw(6) << count << setw(9) << lowest << setw(9)
         << highest << setw(9) << average << endl;
    return 0;
}
